...
% read in image
I = im2double(imread('set1_original.jpg'));
I_gray = rgb2gray(I);
...
%%
% set 1 https://jojo.fandom.com/wiki/Hirohiko_Araki_JoJo_Exhibition_2012?file=Exhib8.jpg
% set 2 https://www.pexels.com/photo/an-island-with-cottages-and-beach-chairs-1174732/
%% detete vertical seams when protecting a region
a = delete_seam_vertical_mask(I, 90, true, mask);
imwrite(a, "set1_carved3.jpg");

%% detete horizontal seams when protecting a region
a = delete_seam_horizontal_mask(I, 90, true, mask);
imwrite(a, "set1_carved6.jpg");

%% inserting vertical seam when protecting a region
a = insert_seam_vertical_mask(I, 50, true, mask);
imwrite(a, "set1_carved7.jpg");

%% inserting horizontal seam when protecting a region
a = insert_seam_horizontal_mask(I,50, true, mask);
imwrite(a, "set1_carved8.jpg");
